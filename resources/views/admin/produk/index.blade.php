        ...
        <form action="{{ route('admin.produk.store') }}" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" name="name"
              id="produk" aria-describedby="helpId" placeholder="Masukan nama produk ..." value="{{ old('name') }}">
            @error('name')
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control {{ $errors->has('harga') ? 'is-invalid' : '' }}" name="harga"
              id="harga-create" aria-describedby="helpId" placeholder="Masukan nama harga ..."
              value="{{ old('harga') }}">
            @error('harga')
